...
const WitsHeroSection = () => {
  return (
    <>
      {/* HERO (original side-by-side layout) */}
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
        ...
        <div className="mx-auto w-full grid lg:grid-cols-2 gap-16 items-center z-10">
          ...
          <div className="flex justify-start relative">
            ...
            {/* Overlapping GIF positioned relative to logo */}
            <img
            src="/images/closedphone.gif"
            alt="Closed phone animation"
            className="absolute bottom-[-5vw] left-[5vw] object-contain h-auto transform -scale-x-100 w-[45vw] max-w-[420px] min-w-[180px]"
            />
          </div>
