        ...
        style = {{paddingBottom: "clamp(220px, 28vw, 140px)"}}>
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-left">
                ...
                <div className= "relative inline-block">
                    <h2 className="[text-shadow:1px_1px_2px_rgba(0,0,0,1)] text-base text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold italic leading-relaxed">
                ...
                <div className="flex flex-col md:flex-row md:items-start max-w-4xl mx-auto gap-11">
                    ...
                    <div className="relative w-full max-w-[400px] min-w-[250px] sm:mt-[-10px] mx-auto lg:mt-[-50px]">
                        <Image
                        src="/images/tv.png"
                        alt=""
                        aria-hidden
                        ...
                        />
                        <div className="absolute -top-[-10%] right-[5%] w-[20px] sm:w-[25px] md:w-[30px]">
                            <Image
                            src="/images/topstars.png"
                            alt=""
                            aria-hidden
